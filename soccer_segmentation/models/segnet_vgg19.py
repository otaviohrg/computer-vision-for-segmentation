...
def segnet_vgg19(
    ...
    pool_3, mask_3 = MaxPoolingWithArgmax2D(pool_size)(base_model.get_layer("block3_conv4").output)

    pool_4, mask_4 = MaxPoolingWithArgmax2D(pool_size)(base_model.get_layer("block4_conv4").output)

    pool_5, mask_5 = MaxPoolingWithArgmax2D(pool_size)(base_model.get_layer("block5_conv2").output)
...
if __name__ == "__main__":
    resseg = segnet_vgg19(input_shape=(256, 256, 3), n_labels=3)
    resseg.summary()
