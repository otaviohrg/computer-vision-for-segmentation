...
def segnet_mobilenetsmall(
    ...
    pool_2, mask_2 = MaxPoolingWithArgmax2D(pool_size)(base_model.get_layer("re_lu_3").output)

    pool_3, mask_3 = MaxPoolingWithArgmax2D(pool_size)(base_model.get_layer("multiply_1").output)

    pool_4, mask_4 = MaxPoolingWithArgmax2D(pool_size)(base_model.get_layer("multiply_11").output)

    pool_5, mask_5 = MaxPoolingWithArgmax2D(pool_size)(base_model.get_layer("multiply_17").output)

    # decoder

    unpool_1 = MaxUnpooling2D(pool_size)([pool_5, mask_5])

    conv_14 = Convolution2D(576, (kernel, kernel), padding="same")(unpool_1)
    conv_14 = BatchNormalization()(conv_14)
    conv_14 = Activation("relu")(conv_14)
    conv_15 = Convolution2D(576, (kernel, kernel), padding="same")(conv_14)
    conv_15 = BatchNormalization()(conv_15)
    conv_15 = Activation("relu")(conv_15)
    conv_16 = Convolution2D(288, (kernel, kernel), padding="same")(conv_15)
    conv_16 = BatchNormalization()(conv_16)
    conv_16 = Activation("relu")(conv_16)

    unpool_2 = MaxUnpooling2D(pool_size)([conv_16, mask_4])

    conv_17 = Convolution2D(288, (kernel, kernel), padding="same")(unpool_2)
    conv_17 = BatchNormalization()(conv_17)
    conv_17 = Activation("relu")(conv_17)
    conv_18 = Convolution2D(288, (kernel, kernel), padding="same")(conv_17)
    conv_18 = BatchNormalization()(conv_18)
    conv_18 = Activation("relu")(conv_18)
    conv_19 = Convolution2D(96, (kernel, kernel), padding="same")(conv_18)
    conv_19 = BatchNormalization()(conv_19)
    conv_19 = Activation("relu")(conv_19)

    unpool_3 = MaxUnpooling2D(pool_size)([conv_19, mask_3])

    conv_20 = Convolution2D(96, (kernel, kernel), padding="same")(unpool_3)
    conv_20 = BatchNormalization()(conv_20)
    conv_20 = Activation("relu")(conv_20)
    conv_21 = Convolution2D(96, (kernel, kernel), padding="same")(conv_20)
...
if __name__ == "__main__":
    resseg = segnet_mobilenetsmall(input_shape=(256, 256, 3), n_labels=3)
    resseg.summary()
